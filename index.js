...
//The nested function can access the varibale `internal` because the parent function contains thta variable and 
// all child functions have access to parent function variable scope. 
...
const zooAnimals = [
  ...
  */
  function lowerCaseNames(obj){
    let lowCaseAnimalNames = obj.map(i => i.animal_name.toLowerCase())
  ...
  */
  function lowPopulationAnimals(obj){
    let lowPopulationAnimals = obj.filter(i => i.population < 5)
